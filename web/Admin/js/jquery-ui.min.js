            ...
            this.element.addClass("ui-autocomplete-input").attr("autocomplete","off").attr({
                ...
                switch(d.keyCode){
                    ...
                    case e.ESCAPE:
                        ...
                        b.close(d);
                        break;
                    case e.SHIFT:case e.CONTROL:case 18:
                        break;
                    default:
...
(function(b){
    ...
    b.widget("ui.dialog",{
        ...
        _create:function(){
            ...
            var k=this,l=k.options,i=l.title||k.originalTitle||"&#160;",d=b.ui.dialog.getTitleId(k.element),j=(k.uiDialog=b("<div></div>")).appendTo(document.body).hide().addClass(a+l.dialogClass).css({
                zIndex:l.zIndex
