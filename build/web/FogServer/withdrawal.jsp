...
//                out.write("alert( " + "' Please Give Answers Some Sequriy Question Then You Are Able to Withdrawal '" + ");\n");
...
//            ma.Visit(session.getAttribute("sid").toString(), ma.getOldLinks(session.getAttribute("sid").toString()) + "," + request.getRequestURL().toString());
        ...
        <form name="with1" method="post" action="withdrawal1.jsp" onsubmit="return f1(with1);"
