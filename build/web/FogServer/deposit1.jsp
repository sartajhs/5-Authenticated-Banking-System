            ...
            <div id="content_wrapper">
                ...
                <div class="content_box">
                    ...
                    <%
                        ...
                        int bal1 = 0;
//                        MyAdo md = new MyAdo();
                        String str = "ok";// md.deposit(loginname, amount, date);
//                        try {
...
//                            if (rs.next()) {
                    ...
                    %>
                    <center>
                        <strong><font size="4">You Deposit:- <%=amount%></font><br/>
                    ...
                    <%
                                ...
                                out.write("alert( " + "' Your Balance is:- " + bal1 + ". You can not Deposit Mony. Try After Some Time. '" + ");\n");
