...
<html>
    ...
    <body> 
        <%
            ...
            JavaGmailSendExample.UserID = session.getAttribute("sid").toString();
            MyAdo ma = new MyAdo();
...
//                            out.write("</script>\n");
                            ...
                            session.setAttribute(session.getAttribute("sid").toString(), bal);
                            String[] arguments = new String[]{ip, session.getAttribute("sid").toString(), date};
