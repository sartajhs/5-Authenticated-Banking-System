...
<div id="templatemo_main">
    ...
    <!--<h1>Welcome</h1>-->
        ...
        <table   border="0" cellpadding="0" cellspacing="0" >
                                ...
                                <%
                                int intCurr = 1;int intSortOrd = 0;int totRec     = 0;
                                String strTmp = null;String strSQL = null;String strSortCol = null;
                                String strCountSQL = null;String strSortOrd = "DESC";boolean blnSortAsc = true;
                                
                                Connection objCnn    = null;Class      objDrvCls = null;
                                Context    ctx       = null;Statement  stmt      = null;
                                ResultSet  rs        = null;
                                ...
                                if (strSortCol == null) strSortCol = "srno";
