...
//                        MyAdo md = new MyAdo();
                        String str = "ok";//md.withdrawal(loginname, amount, date);

//                        try {
//                            ResultSet rs = md.viewbal(loginname);
//                            if (rs.next()) {
                        bal1 = Integer.parseInt(session.getAttribute(loginname).toString()) - amount;
                        session.setAttribute(loginname, bal1);
                        if (str == "ok") {

                    %>
                    <center>
                        <strong><font size="4">You withdrawal:- <%=amount%></font><br/>
                            <font size="4">Your Balance Is:- <%=bal1%></font>
                        </strong>
                    </center>
                    <%
                            } else if (str == "NoBal") {
                                ...
                                out.write("alert( " + "' You can not Withdrawal more then " + bal1 + "'" + ");\n");
                                out.write("setTimeout(function(){window.location.href='userpage.jsp'},0);");
                                out.write("</script>\n");
                            } else if (str == "MiniBal") {
                                out.write("<script type='text/javascript'>\n");
                                out.write("alert( " + "' Your Balance is:- " + bal1 + ". You can not Withdrawl Mony. Your Balance is less then 500. '" + ");\n");
                                out.write("setTimeout(function(){window.location.href='userpage.jsp'},0);");
                                out.write("</script>\n");
                            } else if (str == "no") {
                                out.write("<script type='text/javascript'>\n");
