<%-- 
    Document   : Login1
    Created on : May 23, 2013, 10:01:27 AM
    Author     : Praful
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="js/resetCaptcha.js"></script>
    </head>
    <body>
        <div class="main">
            <div class="header">
                ...
                <div class="content_resize">
                    <div class="mainbar">
                        <div class="article">
                            ...
                            <div class="clr"></div>
                            <form name="login" method="post" action="checklogin.jsp?term=2" onsubmit="return log(login);">
                                <table border="0" align="center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr><td colspan="2" align="center">Please Enter The String Shown In Image</td></tr>
                                        <tr>
                                            <td>

                                                <img src="capcha.jsp" id="imgCaptcha">
                                                    <img src="images/refresh.png" border=0 id="imgRefresh" onclick="setTimeout('resetCaptcha()', 300); return false;">
                                                        </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
